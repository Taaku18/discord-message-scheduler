...
This bot is build on Python 3.13. You will need to download the latest version of Python using any of the methods below.
...
* Using APT (Debian/Ubuntu):
  ...
  sudo apt update
  sudo apt install python3.13 python3.13-dev software-properties-common
...
[Python.org]: https://img.shields.io/badge/Python-3.13-45697E?style=for-the-badge&logo=python&logoColor=white
